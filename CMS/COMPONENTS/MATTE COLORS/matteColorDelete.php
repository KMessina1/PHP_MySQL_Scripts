...
http://sqframe.com/client-tools/squareframe/scripts/cms/components/matteColorDelete.php?
id=6&
...
try {
    ...
    $query =
        ...
        ;
    ";
    $success = executeDB($query,$stack,$debug,$tableName,$dbAction_Delete);
    $found = (int)$success;
} catch (Exception $e) {
