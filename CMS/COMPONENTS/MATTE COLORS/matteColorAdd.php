...
http://sqframe.com/client-tools/squareframe/scripts/cms/components/matteColorAdd.php?
name=TEST&
description=TEST&
code=ZZ&
active=0&
...
try {
    ...
    $query =
        ...
        ;
    ";
    $success = executeDB($query,$stack,$debug,$tableName,$dbAction_Insert);
    $found = (int)$success;
} catch (Exception $e) {
